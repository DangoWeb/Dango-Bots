...
<html lang="en">
  ...
  <body>
	...
	<img src="../title-white.png" style="width:90%;margin-left:12px;margin-top:10px" />
    ...
    <div class="side-bar">
        <nav role="navigation" aria-label="Main" id="site-nav" class="site-nav">
            ...
            {% endfor %}
            {% else %}
            {% include nav-none.html pages=site.html_pages %}
            {% endif %}
        </nav>
    </div>
      <!--<section class="menu-section">
...
<div class="stickyhead" id="stickyhead">
        ...
        <button class="btn-hamburger js-slideout-toggle">
          <span class="tooltip">Browse the Docs</span>
        </button>
</div>
	<br /><br /><br /><br />
...
<script>
// When the user scrolls the page, execute stickyheaderScript
window.onscroll = function() {stickyheaderScript()};
